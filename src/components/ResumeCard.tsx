            ...
            {sections.contact && (
                <div className="resume-section">
                    ...
                    <div className="contact-grid">
                        {sections.contact.full_name && (
                            <div className="contact-item">
                                <span className="contact-label">Name</span>
                                <span className="contact-value">{sections.contact.full_name}</span>
                            </div>
                        )}
                        ...
                        {sections.contact.linkedin && (
                            <div className="contact-item">
                                ...
                                <a href={sections.contact.linkedin} target="_blank" rel="noopener noreferrer" className="contact-value contact-link">
                                    View Profile
                                </a>
                            </div>
                        )}
                        {sections.contact.github && (
                            <div className="contact-item">
                                ...
                                <a href={sections.contact.github} target="_blank" rel="noopener noreferrer" className="contact-value contact-link">
                                    View Profile
                                </a>
                            </div>
                        )}
